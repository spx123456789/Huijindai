...
#define pageColor kRGB_Color(67, 199, 176)
...
@interface HKScrollView () <UIScrollViewDelegate>


@end

@implementation HKScrollView
{
...
- (void)changeImageLeft:(NSInteger)LeftIndex center:(NSInteger)centerIndex right:(NSInteger)rightIndex
{
    if (_isNetworkImage)
    {
        ...
        [_leftImageView sd_setImageWithURL:LeftIndex<_imageArray.count?[NSURL URLWithString:_imageArray[LeftIndex]]:nil placeholderImage:_placeholderImage];
        [_centerImageView sd_setImageWithURL:centerIndex<_imageArray.count?[NSURL URLWithString:_imageArray[centerIndex]]:nil placeholderImage:_placeholderImage];
        [_rightImageView sd_setImageWithURL:rightIndex<_imageArray.count?[NSURL URLWithString:_imageArray[rightIndex]]:nil placeholderImage:_placeholderImage];
