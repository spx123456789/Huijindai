...
- (void)configCellWithArray:(NSArray*)array {
    ...
    if (model1) {
        ...
        self.button1.unreadCount = model1.unreadCount.integerValue;
    } else {
    ...
    if (model2) {
        ...
        self.button2.unreadCount = model2.unreadCount.integerValue;
    } else {
    ...
    if (array.count>2){
        ...
        if (model3) {
            ...
            self.button3.unreadCount = model3.unreadCount.integerValue;
        } else {
