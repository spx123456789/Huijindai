...
@interface HJDMyAgentViewController ()<UITableViewDelegate, UITableViewDataSource, HJDMyNavTextFieldSearchViewDelegate, HJDMyAgentTableViewCellDelegate>
...
- (void)searchWithKeyWord:(NSString *)keyWord {
    ...
    [HJDMyManager getMyAgentWithKeyWork:keyWord callBack:^(NSArray *arr, BOOL result) {
